...
function Button({ children, disabled, to, type, onClick }) {
  const base = `inline-block text-sm rounded-full bg-yellow-400 font-semibold uppercase
...
`;
  const styles = {
    ...
    focus:bg-stone-300 focus:text-stone-800 focus:outline-none focus:ring  focus:ring-stone-200 
